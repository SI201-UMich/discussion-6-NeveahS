...
###############################################################################
    ...
    def horse_fastest_race(self, horse):
        ...
        for race in self.race_dict[horse]:
            value = self.race_dict[horse][race]
...
###############################################################################
    ...
    def horse_personal_best(self):
        ...
        for horse in self.race_dict:
            output[horse] = self.horse_fastest_race(horse)
        return output
...
###############################################################################
    ...
    def get_average_time(self):
        ...
        output = {}
        for horse in self.race_dict:
            output[horse] = sum(self.race_dict[horse].values()/ len(self.race_dict[horse].values()))
        return output
